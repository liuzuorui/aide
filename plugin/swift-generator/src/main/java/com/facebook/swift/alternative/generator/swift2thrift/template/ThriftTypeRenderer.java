 ...
 * under the License.
 */
package com.facebook.swift.alternative.generator.swift2thrift.template;
...
public class ThriftTypeRenderer implements AttributeRenderer
{
    ...
    public String toString(ThriftType t)
    {
        switch (t.getProtocolType()) {
            ...
            case MAP:       return "map<" + toString(t.getKeyTypeReference().get()) + ", " + toString(t.getKeyTypeReference().get()) + ">";
            case SET:       return "set<" + toString(t.getKeyTypeReference().get()) + ">";
            case LIST:      return "list<" + toString(t.getKeyTypeReference().get()) + ">";
